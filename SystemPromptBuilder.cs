internal static class SystemPromptBuilder
{
    public static string Build(PersonalityProfile profile)
    {
        ...
        return string.Join('\n', new[]
        {
            ...
            "When the user asks to list pending/open/incomplete todos from Voice Admin, call list_voice_admin_open_todos. Use projectOrCategory when the user mentions a category or project.",
            "Treat conversational todo phrases as shortcuts to list_voice_admin_open_todos, including: 'what's left', 'what do I still need to do', 'show my open tasks', 'todo list', and 'what is still pending'.",
            ...
            "When the user asks to add a new Voice Admin todo, call add_voice_admin_todo with the requested title and any provided description/project/priority details.",
            "Treat conversational add phrases as shortcuts to add_voice_admin_todo, including: 'remind me to', 'add task', 'note to self', and 'create a todo'.",
