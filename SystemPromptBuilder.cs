internal static class SystemPromptBuilder
{
    public static string Build(PersonalityProfile profile)
    {
        ...
        return string.Join('\n', new[]
        {
            ...
            "For Voice Admin launcher interactions, use the voice-admin-launcher skill and avoid embedding detailed launcher operation rules in the main system prompt.",
            ...
            "For Voice Admin launcher interactions, use the voice-admin-launcher skill and avoid detailed launcher flow instructions in the main system prompt.",
            ...
            "When the user asks to create a todo and does not explicitly specify a repository or location, ALWAYS call add_personal_todo to create the issue in Mark-Phillipson/Personal-Todos. If the user names another repository, ask for explicit confirmation before creating the issue there. Do not use Voice Admin todo write operations for personal todos.",
