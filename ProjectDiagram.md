```mermaid
mindmap
  root((Personal<br/>Assistant))
    Transport Modes
      Telegram Bot
        Long Polling
        Per-chat AI Sessions
        Slash Commands
        Attachment Support
    ...
    Personality System
      ...
      Custom Greeting and Farewell
      Per-chat Profile Override
